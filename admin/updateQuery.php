        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4 mt-5">
                    <h1 class="mb-4">Soru Güncelle</h1>


                    <form action="actions/updateQuestion.php" method="POST">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Soru Açıklaması Giriniz" name="question" id="question" style="height: 150px"><?php echo $_question[0]['question']; ?></textarea>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Soru Açıklaması Giriniz" name="optionA" id="optionA" style="height: 100px"><?php echo $_question[0]['optionA']; ?></textarea>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Soru Açıklaması Giriniz" name="optionB" id="optionB" style="height: 100px"><?php echo $_question[0]['optionB']; ?></textarea>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Soru Açıklaması Giriniz" name="optionC" id="optionC" style="height: 100px"><?php echo $_question[0]['optionC']; ?></textarea>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Soru Açıklaması Giriniz" name="optionD" id="optionD" style="height: 100px"><?php echo $_question[0]['optionD']; ?></textarea>
                        ...
                        <div class="d-flex justify-content-center">
                            <button name="create" class="my-5 px-5 btn btn-primary btn-user btn-block">Soru Güncelle</button>
