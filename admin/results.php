...
$results = $db->prepare("SELECT * FROM answers  LEFT JOIN students ON answers.studentID =students.id LEFT JOIN exams ON exams.id = answers.examID");
$results->execute();
