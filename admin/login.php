...
if (isset($_SESSION['adminEmail']) && isset($_SESSION['adminID'])) {
    ...
    if ($ctrl > 0) {
        header("Location:/online-sinav-sistemi/admin/index.php?session=ok");
        exit;
    }
}
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">ADMİN PANELİ GİRİŞ!</h1>
                                    </div>
                                    <form class="user" action="actions/loginAct.php" method="POST">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" name="email" id="email" aria-describedby="emailHelp" placeholder="E-Posta Adresi">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="register.php">Yeni bir hesap oluştur!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
