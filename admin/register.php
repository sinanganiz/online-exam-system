                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Bir <b>Yönetici</b> Hesabı Oluştur!</h1>
                            </div>
                            <form class="user" method="POST" action="actions/registerAct.php">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="username" id="username" placeholder="Kullanıcı Adı">
                                </div>
                                <div class="form-group">
                                <div class="form-group">
